...
st.caption("Assistente controllato: usa dati scaricati, score, entry zone e scenari. Non promette acquisti/vendite sicuri.")
...
if prompt:
    ...
    with st.chat_message("assistant"):
        if not tickers:
            ...
            st.dataframe({k: [v] for k, v in r.items() if k in cols}, use_container_width=True)
        else:
